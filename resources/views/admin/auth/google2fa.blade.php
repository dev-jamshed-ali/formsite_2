    ...
    <div class="row g-4 min-100 m-0 p-0">
        ...
        <div class="col-12 col-md-8  d-flex justify-content-center align-items-center">
            <div class="main-form-div form-otp px-3 py-5">
                <form method="POST" id="2fa_form" action="{{ route('google2fa.post') }}">
                    @csrf
                    <h1 class="font-big2-700">2FA VERIFICATION</h1>
                    <p class="font-sm-400 mb-4 otp-digit-text">
                       Add your 2FA code here
                    </p>
                    ...
                    <div class="mb-3 ps-0 form-check">
                        <p class="d-flex flex-wrap justify-content-between">
                            ...
                            <span><a class="link-hover text-dark" href="{{ route('2fa.index') }}">Try another Method?</a></span>
                        </p>
                    </div>
