        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="job_title" class="form-control @error('job_title') is-invalid @enderror" value="{{ old('job_title') }}" autofocus>
                    @error('job_title')
                ...
                <div class="form-group">
                    ...
                    <textarea name="job_description_short" class="form-control h_100 @error('job_description_short') is-invalid @enderror" cols="30" rows="10">{{ old('job_description_short') }}</textarea>
                    @error('job_description_short')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    <label for="">Responsibility *</label>
                    <textarea name="job_responsibility" class="form-control editor @error('job_responsibility') is-invalid @enderror" cols="30" rows="10">{{ old('job_responsibility') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input id="datepicker" type="text" name="job_deadline" class="form-control @error('job_deadline') is-invalid @enderror" value="{{ old('job_deadline') }}">
                    @error('job_deadline')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
