...
@section('content')
    ...
    <video id="ginicoe_video" width="100%" controls loop autoplay muted>
        <source src="{{ asset('public/uploads/' . (isset($general_setting) ? $general_setting->video : '')) }}" type="video/mp4">
    ...
    @if (isset($page_home) && $page_home->why_choose_status == 'Show')
        <div class="feature">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
    ...
    @if (isset($page_home) && $page_home->special_status == 'Show')
    ...
    @if (isset($page_home) && $page_home->service_status == 'Show')
        <div class="service">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
    ...
    @if (isset($page_home) && $page_home->testimonial_status == 'Show')
    ...
    @if (isset($page_home) && $page_home->project_status == 'Show')
        <div class="project">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
    ...
    @if (isset($page_home) && $page_home->team_member_status == 'Show')
    ...
    @if (isset($page_home) && $page_home->appointment_status == 'Show')
    ...
    @if (isset($page_home) && $page_home->latest_blog_status == 'Show')
        <div class="blog-area d-none">
    ...
    @if (isset($page_home) &&  $page_home->newsletter_status == 'Show')
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="logos-carousel owl-carousel"> 
                        <div class="logos-item wow fadeInUp">
                            <div class="photo">
                                <a href="#"><img src="{{ asset('public/uploads/logos/GDPR-logo.png') }}" alt="GDPR" title="GDPR" /></a>
                            </div>
                        </div>
                        <div class="logos-item wow fadeInUp">
                            <div class="photo">
                                <a href="#"><img src="{{ asset('public/uploads/logos/iso 270001.png') }}" alt="iso 270001" title="iso 270001" style="width: 106px; height: 106px;" /></a>
                            </div>
                        </div>
                        <div class="logos-item wow fadeInUp">
                            <div class="photo">
                                <a href="#"><img src="{{ asset('public/uploads/logos/pci-dss.jpg') }}" alt="pci-dss" title="pci-dss" /></a>
                            </div>
                        </div>
                        <div class="logos-item wow fadeInUp">
                            <div class="photo">
                                <a href="#"><img src="{{ asset('public/uploads/logos/PIPEDA.png') }}" alt="PIPEDA" title="PIPEDA" style="width: 115px;" /></a>
                            </div>
                        </div>
                        <div class="logos-item wow fadeInUp">     
                            <div class="photo">
                                <a href="#"><img src="{{ asset('public/uploads/logos/satguarantee_seal_white.jpg') }}" style="width: 110px; height: 123px;" alt="satguarantee_seal_white" title="satguarantee_seal_white" /></a>
                            </div>
                        </div>
                        <div class="logos-item wow fadeInUp">
                            <div class="photo">
                                <a href="#"><img src="{{ asset('public/uploads/logos/ssl-certificate-icon-secure-encryption-v.png') }}" alt="ssl-certificate-secure-encryption" title="ssl-certificate-secure-encryption" /></a>
                            </div>
                        </div>
                        <div class="logos-item wow fadeInUp">
                            <div class="photo">
                                <a href="#"><img src="{{ asset('public/uploads/logos/ssl-logo.png') }}" style="width: 120px;" alt="ssl"  title="ssl" /></a>
                            </div>
                        </div>  
                    </div>
                </div>
