...
class UpdateMyInfoController extends Controller
{
    ...
    public function store(Request $request)
    {
     ...
     $merchant =    Merchant::updateOrCreate(
        ...
        return redirect()->route('admin.dashboard')->with('success', 'Your information has been saved successfully.');        // return back()->with('success','Your Information saved successfully');
    }
