...
class UpdateMyInfoController extends Controller
{
    public function index()
    {
        ...
        return response()->json( ['success' => __('Fetched successfully!'), "record" => $bank], 200); 
    }

    public function store(Request $request)
    {
        $bankId = $request->bank_id ?? session('id');
       ...
       $bank =  Bank::updateOrCreate(
        ...
        return response()->json(['success' => true, 'message' => 'form submitted successfully', "record" => $bank]);
    }
}
