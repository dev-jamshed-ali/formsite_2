...
use DB;
use Mail;
use App\Mail\JobApplicationMessageToAdmin;
class JobController extends Controller
{
    ...
    public function apply_form(Request $request)
    {
        ...
        $message = 'New job application received from '.$request->applicant_first_name.' '.$request->applicant_last_name.'. Please check the admin panel for more details.';
        Mail::to("job@ginicoe.com")->send(new JobApplicationMessageToAdmin($subject,$message));
